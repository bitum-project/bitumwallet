...
import (
	...
	"github.com/bitum-project/bitumwallet/internal/prompt"
	"github.com/bitum-project/bitumwallet/internal/zero"
	ldr "github.com/bitum-project/bitumwallet/loader"
	"github.com/bitum-project/bitumwallet/p2p"
	"github.com/bitum-project/bitumwallet/rpc/legacyrpc"
	"github.com/bitum-project/bitumwallet/rpc/rpcserver"
	"github.com/bitum-project/bitumwallet/spv"
	"github.com/bitum-project/bitumwallet/ticketbuyer/v2"
...
func run(ctx context.Context) error {
	...
	// the trusted bitumd server.  This blocks until cancelled.
	if !cfg.NoInitialLoad {
		if done(ctx) {
			return ctx.Err()
		}
...
// startChainRPC opens a RPC client connection to a bitumd server for blockchain
...
func startChainRPC(ctx context.Context, certs []byte) (*chain.RPCClient, error) {
	...
	rpcc, err := chain.NewRPCClientConfig(activeNet.Params, &bitumrpcclient.ConnConfig{
		Host:                 cfg.RPCConnect,
		Endpoint:             "ws",

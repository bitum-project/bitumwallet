...
// walletTestConfig contains all the args, and data required to launch a bitumwallet process
...
// command returns the exec.Cmd which will be used to start the bitumwallet
// process.
...
// to connect to the bitumwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for bitumwallet.
...
// Start creates a new bitumwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running bitumwalletTest process process, and waits until it exits

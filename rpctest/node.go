...
// nodeConfig contains all the args, and data required to launch a bitumd process
...
// command returns the exec.Cmd which will be used to start the bitumd process.
...
// to connect to the bitumd process that is launched via Start().
...
// as the base for the log and data directories for bitumd.
...
// Start creates a new bitumd process, and writes its pid in a file reserved for
...
// Stop interrupts the running bitumd process, and waits until it exits properly.

...
func StakePoolTicketFee(stakeDiff bitumutil.Amount, relayFee bitumutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) bitumutil.Amount {
	...
	return bitumutil.Amount(num.Int64())
}

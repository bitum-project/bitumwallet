...
func NewRescanFilter(addresses []bitumutil.Address, unspentOutPoints []*wire.OutPoint) *RescanFilter {
	filter := &RescanFilter{
		pubKeyHashes:        map[[ripemd160.Size]byte]struct{}{},
		scriptHashes:        map[[ripemd160.Size]byte]struct{}{},
		compressedPubKeys:   map[[33]byte]struct{}{},
...
func (f *RescanFilter) AddAddress(a bitumutil.Address) {
	switch a := a.(type) {
...
func (f *RescanFilter) ExistsAddress(a bitumutil.Address) (ok bool) {
	switch a := a.(type) {
	case *bitumutil.AddressPubKeyHash:
...
func (f *RescanFilter) RemoveAddress(a bitumutil.Address) {
	switch a := a.(type) {
	case *bitumutil.AddressPubKeyHash:

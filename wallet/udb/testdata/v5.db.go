...
import (
	...
	"github.com/bitum-project/bitumutil"
	"github.com/bitum-project/bitumutil/hdkeychain"
	"github.com/bitum-project/bitumwallet/wallet/internal/txsizes"
	"github.com/bitum-project/bitumwallet/wallet/walletdb"
	_ "github.com/bitum-project/bitumwallet/wallet/internal/bdb"
...
func setup() error {
	...
	return walletdb.Update(db, func(dbtx walletdb.ReadWriteTx) error {
		...
		wif, err := bitumutil.NewWIF(privKey, chainParams, chainec.ECTypeSecp256k1)
		if err != nil {
			return err
		}
...
func createUnsignedTicketPurchase(prevOut *wire.OutPoint,
	inputAmount, ticketPrice bitumutil.Amount) (*wire.MsgTx, error) {
	...
	pkScript, err = txscript.GenerateSStxAddrPush(addr,
		bitumutil.Amount(amountsCommitted[0]), ticketFeeLimits)
	if err != nil {
		return nil, err
	}

...
import (
	...
	hd "github.com/bitum-project/bitumd/hdkeychain"
	...
	"github.com/bitum-project/bitumwallet/validate"
...
// exists address index of a trusted bitumd RPC server.
type existsAddrIndexFinder struct {
	wallet *Wallet
	client *rpc.Client
}

func (f *existsAddrIndexFinder) addressesUsed(addrs []bitumutil.Address) (bitset.Bytes, error) {
	const op errors.Op = "bitumd.jsonrpc.existsaddresses"

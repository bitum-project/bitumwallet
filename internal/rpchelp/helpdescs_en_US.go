...
var helpDescsEnUS = map[string]string{
	...
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in BITUM/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in bitum",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in bitum",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in bitum",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and bitum amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in bitum",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in bitum",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in bitum",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in bitum",
	...
	"listunspentresult-amount":        "The amount of the output valued in bitum",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in bitum",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in bitum to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in bitum",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in bitum",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in bitum",
	...
	"setticketmaxprice-max":       "The max price (in bitum).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in bitum",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in bitum.",
	...
	"getwalletfee--result0":  "Current tx fee (in BITUM)",
	...
	"purchaseticket-ticketfee":          "The transaction fee rate (BITUM/kB) to use (overrides fees set by the wallet config or settxfee RPC)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in bitum",

...
type configJSON struct {
	...
	DcrctlArgs    string `json:"bitumctlargs"`
}
...
func convertJSONUnspentToOutPoints(
	utxos []bitumjson.ListUnspentResult) []*extendedOutPoint {
	...
	for _, utxo := range utxos {
		...
		eop.op = op
		amtCast, _ := bitumutil.NewAmount(utxo.Amount)
...
func main() {
	...
	var utxos []bitumjson.ListUnspentResult
	...
	sendToAddress, err := bitumutil.DecodeAddress(cfg.SendToAddress)
	if err != nil {

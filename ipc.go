...
// processes to communicate with and and manage the lifetime of a bitumd child
...
// message, shutdown begins.  This prevents bitumd from continuing to run
...
// for a child bitumd process to communicate with a parent process without the

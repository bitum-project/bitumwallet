...
// interface.
func (s *Syncer) LoadTxFilter(ctx context.Context, reload bool, addrs []bitumutil.Address, outpoints []wire.OutPoint) error {
	s.filterMu.Lock()
...
func (s *Syncer) StakeDifficulty(ctx context.Context) (bitumutil.Amount, error) {

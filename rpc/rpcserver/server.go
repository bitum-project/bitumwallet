...
//
//   https://github.com/bitum-project/bitumwallet/blob/master/rpc/documentation/api.md
//
// Any API changes must be performed according to the steps listed here:
//
//   https://github.com/bitum-project/bitumwallet/blob/master/rpc/documentation/serverchanges.md
package rpcserver
...
import (
	...
	"github.com/bitum-project/bitumd/addrmgr"
	...
	"github.com/bitum-project/bitumwallet/internal/cfgutil"
	h "github.com/bitum-project/bitumwallet/internal/helpers"
	"github.com/bitum-project/bitumwallet/internal/zero"
	"github.com/bitum-project/bitumwallet/loader"
	...
	"github.com/bitum-project/bitumwallet/spv"
	"github.com/bitum-project/bitumwallet/ticketbuyer"
	tbv2 "github.com/bitum-project/bitumwallet/ticketbuyer/v2"
	...
	"github.com/bitum-project/bitumwallet/walletseed"
)
...
// bitumutil.DecodeAddress, which does not perform the network check.
func decodeAddress(a string, params *chaincfg.Params) (bitumutil.Address, error) {
	addr, err := bitumutil.DecodeAddress(a)
	if err != nil {
...
// as well as establishing a RPC connection to a bitumd consensus server.
...
func (s *walletServer) NextAddress(ctx context.Context, req *pb.NextAddressRequest) (
	*pb.NextAddressResponse, error) {
	...
	pubKeyAddr, err := bitumutil.NewAddressSecpPubKey(pubKey.Serialize(), s.wallet.ChainParams())
	if err != nil {
		return nil, translateError(err)
	}
...
func (s *walletServer) ImportPrivateKey(ctx context.Context, req *pb.ImportPrivateKeyRequest) (
	*pb.ImportPrivateKeyResponse, error) {
	...
	wif, err := bitumutil.DecodeWIF(req.PrivateKeyWif)
	if err != nil {
		return nil, status.Errorf(codes.InvalidArgument,
...
func (s *walletServer) ImportScript(ctx context.Context,
	...
	p2sh, err := bitumutil.NewAddressScriptHash(req.Script, s.wallet.ChainParams())
	if err != nil {
		return nil, translateError(err)
	}
...
func (s *walletServer) SweepAccount(ctx context.Context, req *pb.SweepAccountRequest) (*pb.SweepAccountResponse, error) {
	...
	if req.FeePerKb > 0 {
		var err error
		feePerKb, err = bitumutil.NewAmount(req.FeePerKb)
		if err != nil {
...
func (s *walletServer) BlockInfo(ctx context.Context, req *pb.BlockInfoRequest) (*pb.BlockInfoResponse, error) {
	...
	return &pb.BlockInfoResponse{
		...
		ApprovesParent:   header.VoteBits&bitumutil.BlockValid != 0,
	}, nil
}
...
func (s *walletServer) UnspentOutputs(req *pb.UnspentOutputsRequest, svr pb.WalletService_UnspentOutputsServer) error {
	...
	inputDetail, err := s.wallet.SelectInputs(bitumutil.Amount(req.TargetAmount), policy)
...
func (s *walletServer) FundTransaction(ctx context.Context, req *pb.FundTransactionRequest) (
	*pb.FundTransactionResponse, error) {
	...
	if req.IncludeChangeScript && inputDetail.Amount > bitumutil.Amount(req.TargetAmount) {
...
func (s *walletServer) ConstructTransaction(ctx context.Context, req *pb.ConstructTransactionRequest) (
	*pb.ConstructTransactionResponse, error) {
	...
	if req.FeePerKb != 0 {
		feePerKb = bitumutil.Amount(req.FeePerKb)
	}
...
func (s *walletServer) PurchaseTickets(ctx context.Context,
	...
	// purchase request.
	spendLimit := bitumutil.Amount(req.SpendLimit)
	if spendLimit < 0 {
		return nil, status.Errorf(codes.InvalidArgument,
	...
	txFee := bitumutil.Amount(req.TxFee)
	ticketFee := s.wallet.TicketFeeIncrement()

	// Set the ticket fee if specified
	if req.TicketFee > 0 {
		ticketFee = bitumutil.Amount(req.TicketFee)
	}
...
func (s *walletServer) ValidateAddress(ctx context.Context, req *pb.ValidateAddressRequest) (*pb.ValidateAddressResponse, error) {
	...
	case udb.ManagedPubKeyAddress:
		...
		pubKeyAddr, err := bitumutil.NewAddressSecpPubKey(result.PubKey,
...
func marshalBlock(v *wallet.Block) *pb.BlockDetails {
	...
	return &pb.BlockDetails{
		...
		ApprovesParent: v.Header.VoteBits&bitumutil.BlockValid != 0,
		Transactions:   txs,
	}
}
...
func (t *ticketbuyerV2Server) RunTicketBuyer(req *pb.RunTicketBuyerRequest, svr pb.TicketBuyerV2Service_RunTicketBuyerServer) error {
	...
	tb.AccessConfig(func(c *tbv2.Config) {
		...
		c.Maintain = bitumutil.Amount(req.BalanceToMaintain)
...
func (s *messageVerificationServer) VerifyMessage(ctx context.Context, req *pb.VerifyMessageRequest) (
	*pb.VerifyMessageResponse, error) {
	...
	addr, err := bitumutil.DecodeAddress(req.Address)
	if err != nil {
		return nil, translateError(err)
	}
...
func marshalDecodedTxOutputs(mtx *wire.MsgTx, chainParams *chaincfg.Params) []*pb.DecodedTransaction_Output {
	...
	for i, v := range mtx.TxOut {
		...
		var reqSigs int
		var commitAmt *bitumutil.Amount
